 ...
 *
 * REF-011: Refactored to separate legacy validators into validators-legacy.js
 *
 * This module provides MODERN validators for use with requireValidPath middleware:
 ...
 *
 * LEGACY VALIDATORS: For backward compatibility with existing tests,
 * see validators-legacy.js which contains deprecated validators with inline path validation.
 */
...
module.exports = {
    // REF-011: Modern validators for use with requireValidPath middleware
    validateFolderBasic,
    validateGrayscale,
