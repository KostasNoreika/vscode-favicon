...
const MAX_METADATA_SIZE = 5 * 1024; // 5KB serialized size limit
const MAX_NESTING_DEPTH = 3; // Maximum object nesting depth
const ALLOWED_METADATA_KEYS = ['duration', 'user', 'context', 'tags', 'priority']; // Whitelist of allowed keys
