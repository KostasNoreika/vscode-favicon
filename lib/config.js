...
const config = {
    ...
    rateLimitMax: parseInt(process.env.RATE_LIMIT_MAX || '500', 10), // 500 req/min
    rateLimitNotificationWindow: parseInt(
        process.env.RATE_LIMIT_NOTIFICATION_WINDOW || '60000',
        10
    ), // 1 minute in ms
    rateLimitNotificationMax: parseInt(process.env.RATE_LIMIT_NOTIFICATION_MAX || '100', 10), // 100 req/min
