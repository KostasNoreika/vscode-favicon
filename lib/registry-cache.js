...
/**
 * FIX QUA-028: Warm cache on startup to reduce first-request latency
 * Preloads registry into cache before first request
 *
 * @returns {Promise<void>} Resolves when cache is warmed
 * @throws {Error} If registry file cannot be read
 */
