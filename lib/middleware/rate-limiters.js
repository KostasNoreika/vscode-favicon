...
function createDownloadLimiter() {
    // Rate limiter for download endpoint (500 downloads per hour per IP)
    // Higher limit needed for favicon serving and image viewing
    return rateLimit({
        windowMs: 60 * 60 * 1000, // 1 hour
        max: 500, // 500 downloads per hour per IP
