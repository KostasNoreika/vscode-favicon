...
class LRUCache {
    ...
    /**
     * PERF-007: Get all keys in cache (ordered from LRU to MRU)
     *
     * WARNING: This method creates a new array by copying all keys (O(n) time and space).
     * Use only for debugging/testing, not in hot paths.
     * For typical cache sizes (< 1000 items), performance impact is minimal.
     * For memory-efficient iteration, use keysIterator() instead.
     *
    ...
    /**
     * PERF-007: Get all values in cache (ordered from LRU to MRU)
     *
     * WARNING: This method creates a new array by copying all values (O(n) time and space).
     * Use only for debugging/testing, not in hot paths.
     * For typical cache sizes (< 1000 items), performance impact is minimal.
     * For memory-efficient iteration, use valuesIterator() instead.
     *
    ...
    /**
     * PERF-007: Get all entries in cache (ordered from LRU to MRU)
     *
     * WARNING: This method creates a new array by copying all entries (O(n) time and space).
     * Use only for debugging/testing, not in hot paths.
     * For typical cache sizes (< 1000 items), performance impact is minimal.
     * For memory-efficient iteration, use entriesIterator() instead.
     *
    ...
    /**
     * PERF-007: Memory-efficient iterator for keys (O(1) space)
     * @returns {Iterator<string>} Iterator over cache keys
     */
    *keysIterator() {
    ...
    /**
     * PERF-007: Memory-efficient iterator for values (O(1) space)
     * @returns {Iterator<*>} Iterator over cache values
     */
    *valuesIterator() {
    ...
    /**
     * PERF-007: Memory-efficient iterator for entries (O(1) space)
     * @returns {Iterator<[string, *]>} Iterator over cache entries
     */
    *entriesIterator() {
