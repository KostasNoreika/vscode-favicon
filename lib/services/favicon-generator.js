...
class FaviconGenerator {
    ...
    getTypeColor(type, projectName) {
        ...
        // FIX REF-026: Use shared cache key utility (breaks circular dependency)
        const cacheKey = makeCacheKey('color', projectName);
        ...
        // FIX REF-026: Use shared cache key utility
